...
public class WikiSearch_StepDefinitions {
    ...
    public void user_sees_is_in_the_wiki_title(String expectedTitle) {
        ...
        Assert.assertTrue("Verification is failed!",Driver.getDriver().getTitle().contains(expectedTitle));
    }

    @Then("user sees {string} is in the main header")
    public void user_sees_is_in_the_main_header(String expectedHeader) {

        Assert.assertEquals("Verification is failed!", expectedHeader, wikiSearchPage.actualHeader.getText());
    ...
    public void user_sees_is_in_the_image_header(String expectedImageHeader) {
        ...
        Assert.assertEquals("Verification is failed!", expectedImageHeader, wikiSearchPage.actualHeader.getText());
